        ...
        VStack{
            VStack{
                ...
                Text("1.  Unlock unlimited sessions with our voucher, valid for use\n across all available sessions.")
                    .font(.custom("LibreFranklin-Regular", size: 12))
                    .padding(.bottom)
                Text("2.  Don't miss out on this time-sensitive offer! Redeem your\n voucher within 3 days of code generation to enjoy the\n benefits.")
                    .font(.custom("LibreFranklin-Regular", size: 12))
                Text("Redeem Code")
                    .font(.custom("LibreFranklin-SemiBold", size: 14))
                    .padding(.top,30)
...
struct Voucher3View_Previews: PreviewProvider {
